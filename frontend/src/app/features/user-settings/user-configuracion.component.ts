  ...
  readonly L = computed(() => {
    ...
    if (en) {
      return {
        ...
        n1h: '5, 2, and 1 day before; on the due day under 3 h and 1 h',
        n2: 'Daily summary',
        ...
        n6: 'Email digest',
        n6h: 'Daily summary to your account email (server must have SMTP configured)',
    ...
    return {
      ...
      n1h: 'A 5, 2 y 1 día antes; el mismo día a menos de 3 h y 1 h',
      n2: 'Resumen diario',
      ...
      n6: 'Resumen por correo',
      n6h: 'Un correo diario al email de tu cuenta (el servidor debe tener SMTP configurado)',
